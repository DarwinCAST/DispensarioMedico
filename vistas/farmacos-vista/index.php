...
<body>
    ...
    <div class="content">
        <h2 class="text-center mb-4">Gestión de Tipos de Fármacos</h2>
        <?php
        include("/laragon/www/ProyectoDispensarioMedico/controladores/TiposFarmacos/DeleteFarmaco.php");

        ?>

        <div class="btn-create">
            <a href="create.php" class="btn btn-success">
                <i class="fas fa-plus"></i> Crear Fármaco
            </a>
        </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php
                $sql = $conexion->query("SELECT * FROM tipos_farmacos");
                ...
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="edit.php?id=<?= $datos->id_farmaco ?>" class="btn btn-warning btn-sm">
