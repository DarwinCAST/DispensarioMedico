...
<body>
    ...
    <div class="content">
        <h2 class="text-center mb-4">Gestión de Marcas de Fármacos</h2>
        <?php
        include("/laragon/www/ProyectoDispensarioMedico/controladores/MarcasFarmacos/DeleteMarca.php");
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php
                $sql = $conexion->query("SELECT * FROM gestion_marcas");
                    ...
                    <tr>
                       <!--  <th scope="row"><?= $datos->id_marca ?></th> -->
                        ...
                        <td class="text-center">
                            <a href="edit.php?id=<?= $datos->id_marca ?>" class="btn btn-warning btn-sm">
