...
$sql = $conexion->query("select * from gestion_marcas where id_marca = $id");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="index.php"><i class="fas fa-link"></i> Gestion de marcas</a></li>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <?php
                include("/laragon/www/ProyectoDispensarioMedico/controladores/MarcasFarmacos/EditMarca.php");

                while ($datos = $sql->fetch_object()) { ?>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre del Fármaco</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $datos->nombre_marca ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="estado" class="form-label">Estado</label>
                        <select class="form-control" id="estado" name="estado" required>
                            <option value="Activo" <?= ($datos->estado_marca == 'Activo') ? 'selected' : '' ?>>Activo</option>
                            <option value="Inactivo" <?= ($datos->estado_marca == 'Inactivo') ? 'selected' : '' ?>>Inactivo</option>
                        </select>
                    </div>
                <?php }
                ?>
