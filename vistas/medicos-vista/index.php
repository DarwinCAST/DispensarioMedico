...
<body>
    ...
    <div class="content">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php
                $sql = $conexion->query("SELECT * FROM gestion_medicos");

                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        <!-- <th scope="row"><?= $datos->id_medico ?></th> -->
                        <td><?= $datos->nombre_medico ?></td>
                        <td><?= $datos->cedula_medico ?></td>
                        <td><?= $datos->tanda_medico ?></td>
                        <td><?= $datos->especialidad ?></td>


                        <td class="text-center">
                            <a href="edit.php?id=<?= $datos->id_medico ?>" class="btn btn-warning btn-sm">
