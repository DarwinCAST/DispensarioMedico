    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                include("/laragon/www/ProyectoDispensarioMedico/controladores/TiposFarmacos/CreateFarmaco.php");
                ?>
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre de la Fármaco</label>
