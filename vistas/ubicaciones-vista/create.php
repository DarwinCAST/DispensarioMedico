    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                include("/laragon/www/ProyectoDispensarioMedico/controladores/UbicacionesFarmacos/CreateUbicacion.php");
                ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tramo" name="tramo" required>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="Casilla" class="form-label">Casilla</label>
                    <input type="text" class="form-control" id="casilla" name="casilla" required>
                    </select>
                </div>
